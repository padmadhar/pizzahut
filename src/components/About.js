...
function About(){
    return(
        ...
        <Col><img src="./images/about-img.png" alt="" className="img-fluid mx-auto d-block"/></Col>
        <Col><h1 style={{fontFamily:"brush script mt"}}>We Are Feane</h1>
        <p className="fs-5"> There are many variations of passages of Lorem
